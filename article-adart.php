<section class="adart_overide">
    ...
    <section class="content">
        <div class="grid">
            <div class="content-rail pull-8 push-2 pad-mobile-20">
    ...
    <section class="content">
        <div class="grid">
            ...
            <div class="outbox-left google">
                <p class="caption"><i class="icon-caret-up"></i> It’s Google flashing its technology through a gorgeous music video for
            ...
            <div class="outbox-right bmw remove-mobile">
