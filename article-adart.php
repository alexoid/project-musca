<style type="text/css" media="screen">
    @import url("_assets/adart/styles.css");
</style>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-10 pull-8 push-2 pad-mobile-20">
            <p class="first">It’s easy not to like ads. It’s easy to like good art.</p>
...
<section class="content remove-mobile">
    <div class="lovely-grid">
        <div class="grid-22 push-2 pad-mobile-20">
            <div class="quote">
                <p>Consumers are often deeply<br/> suspicious that everyone is<br/> trying to sell them something.<br/> What’s an advertiser to do?</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-4 pull-2 push-1 pad-mobile-20 google remove-mobile">
            <p class="caption"><i class="icon-sort-up"></i> It’s Google flashing its technology through a <a href="http://thewildernessdowntown.com/" title="Arcade Fire" target="blank">gorgeous music video for Arcade Fire</a>.</p>
        </div>
        <div class="grid-4 pull-2 push-1 pad-mobile-20 google inline remove-768 remove-960 remove-1200">
            <p class="caption"><i class="icon-caret-up"></i> It’s Google flashing its technology through a gorgeous music video for <a href="#" title="Arcade Fire">Arcade Fire</a>.</p>
        </div>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-3 pull-2 push-2 pad-mobile-20 toshiba remove-mobile">
            <p class="caption"><i class="icon-sort-up"></i> It’s Toshiba sending the <a href="http://www.youtube.com/watch?v=k6PSbUl_68k" title="first chair to space" target="blank">first chair to space</a> attached to a weather balloon.</p>
        </div>
        <div class="grid-4 pull-2 push-1 pad-mobile-20 toshiba inline remove-768 remove-960 remove-1200">
            <p class="caption"><i class="icon-caret-left"></i> It’s Toshiba sending the <a href="#" title="first chair to space">first chair to space</a> attached to a weather balloon.</p>
        </div>
        <div class="grid-10 pull-1 push-6 pad-mobile-20">
