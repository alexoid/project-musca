...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-4 pull-2 push-1 pad-mobile-20 google remove-mobile">
            <p class="caption"><i class="icon-sort-up"></i> It’s Google flashing its technology through a gorgeous music video for <a href="#" title="Arcade Fire">Arcade Fire</a>.</p>
        </div>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-4 pull-2 push-1 pad-mobile-20 bmw inline remove-768 remove-960 remove-1200">
            <p class="caption"><i class="icon-caret-left"></i> It’s BMW driving cars through a <a href="#" title="giant glass apple">giant glass apple</a>.</p>
        </div>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-3 pull-2 push-2 pad-mobile-20 toshiba remove-mobile">
            <p class="caption"><i class="icon-sort-up"></i> It’s Toshiba sending the <a href="#" title="first chair to space">first chair to space</a> attached to a weather balloon.</p>
        </div>
