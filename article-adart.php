...
<section class="content">
    <div class="lovely-grid">
        ...
        <div class="grid-4 pull-2 push-1 pad-mobile-20 google inline remove-768 remove-960 remove-1200">
            <p class="caption"><i class="icon-caret-up"></i> It’s Google flashing its technology through a gorgeous music video for <a href="http://thewildernessdowntown.com/" title="Arcade Fire">Arcade Fire</a>.</p>
        </div>
...
<section class="content">
    <div class="lovely-grid">
        ...
        <div class="pull-1 grid-3 push-2 pad-mobile-20 bmw remove-mobile">
            <p class="caption"><i class="icon-sort-up"></i> It’s BMW driving cars through a <a href="http://www.youtube.com/watch?v=ZDuxWGHA-Z4&feature=player_embedded" title="giant glass apple">giant glass apple</a>.</p>
        </div>
    </div>
</section>
...
<section class="content">
    <div class="lovely-grid">
        ...
        <div class="grid-4 pull-2 push-1 pad-mobile-20 toshiba inline remove-768 remove-960 remove-1200">
            <p class="caption"><i class="icon-caret-left"></i> It’s Toshiba sending the <a href="http://www.youtube.com/watch?v=k6PSbUl_68k" title="first chair to space">first chair to space</a> attached to a weather balloon.</p>
        </div>
        <div class="grid-10 pull-1 push-6 pad-mobile-20">
