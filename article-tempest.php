...
<section class="hero"><div class="wrapper">
    <div class="lovely-grid">
        ...
        <div class="grid-24">
            <video src="_assets/tempest/tempest.mp4" autoplay="true" loop="true" />
        </div>
    </div>
</div></section>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-10 pull-8 pad-mobile-20">
            <p>Compare flipping through a beautiful, carefully laid-out print magazine to clicking through the modern content site; we’ve lost all sense of design, beauty and craft.</p>
            ...
            <p>This front-end experience is in turn powered by the four major pillars of the Tempest platform: Content, Community, Commerce and Marketing.</p>
            ...
            <p><strong>Tempest Commerce</strong> lets editors extend their point of view all the way to the shopping cart. With an ever-increasing number of options for what we buy and where we buy it, users increasingly need filters to find the best products. Content sites with trusted voices provide a perfect filter; I would much rather look at the 10 lighting fixtures Remodelista recommends than the 10,000 available on Amazon. The data backs this up; when our writers mention products in their posts, the products sell. Commerce is a huge opportunity to create value for the readers while giving publications another way to monetize.</p>
        ...
        <div class="grid-5 pull-1">
            <img src="_assets/tempest/tempest-modules.png">
        </div>
    </div>
</section>