<style type="text/css" media="screen">
    @import url("_assets/savoring-auth/styles.css");
</style>
    ...
    <div class="lovely-grid">
        ...
        <div class="grid-10 pull-1 push-2 pad-mobile-20">
            ...
            <div class=" inline show-mobile">
                <div class="photo">
                    <a href="http://player.vimeo.com/video/61373118?autoplay=1" title="See it in action"><img src="_assets/savoring-auth/video-sm.jpg" alt=""></a>
                    <p class="caption">
                        See it in action
                        <span>0:15 sec</span>
                    </p>
...
<section class="content">
    <div class="lovely-grid">
        <div class="grid-5 pull-2 remove-mobile">
            <div class="photo">
                <a href="https://vimeo.com/61373118" title="See it in action" class="fresco darken"><img src="_assets/savoring-auth/video-sm.jpg" alt=""></a>
        ...
        <div class="grid-14 pull-1 push-2 pad-mobile-20">
            <div class="photo">
                <img src="_assets/savoring-auth/photo-01.png" alt="">
                <p class="caption mobile">The ad drove three and half times the average click-through rate</p>
            </div>
        </div>
        </div>
    </div>
