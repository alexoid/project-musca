...
<div class="grid">
    ...
    <div class="box12 right">
        <div class="grid">
            <div class="col8">
                <div class="photo">
                    <div class="caption"><p>Kris Bitti (OMD), Martin Shaw (Initiative), Amanda Sumargo (OMD), Vinh Mai
                            (OMD)</p>
                    </div>
...
<div class="grid">
    <div class="col12 push0">
        <div class="photo">
            <div class="caption"><p>Vera Fernandes (Say Media), Uma Sekar (Zenith Optimedia), Vicki Connerty
                    (Zenith Optimedia)</p></div>
...
<div class="grid">
    ...
    <div class="col6 push6">
        <div class="photo">
            <div class="caption"><p>Carlos Moller (PHD), Danni Dimitri (PHD), Sisse Marcussen (PHD), Rachel Teh
                    (PHD)</p></div>
